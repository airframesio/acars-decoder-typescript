...
describe('Label_10_Slash', () => {
  ...
  test('decodes Label 10 Preamble / variant 1', () => {
    message.text =
      '/N39.182/W077.217/10/0.42/180/055/KIAD/0004/0028/00015/MOWAT/HUSEL/2349/YACKK/2352/';
    ...
    expect(decodeResult.formatted.items[5].value).toBe(
      'MOWAT > HUSEL@23:49:00 > YACKK@23:52:00',
    );
  ...
  test('decodes Label 10 Preamble / variant 2', () => {
    message.text =
      '/N39.019/W078.468/10/0.83/246/400/KCVG/0155/0073/00018/COLNS/STEVY/0120/FAIIR/0126/KTEB/';
    const decodeResult = plugin.decode(message);
    ...
    expect(decodeResult.formatted.items[5].label).toBe('Aircraft Route');
    expect(decodeResult.formatted.items[5].value).toBe(
      'COLNS > STEVY@01:20:00 > FAIIR@01:26:00',
    );
