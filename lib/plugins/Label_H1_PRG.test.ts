...
describe('Label H1 Preamble PRG', () => {
  ...
  test('decodes Label H1 Preamble PRG/LR', () => {
    ...
    message.text =
      'PRG/LR,000855,SWA786,KBWI,KBOS,04R,25,1285,1192,93,1284,P4,001004,8,141K,D713,000950,2,291483';
    const decodeResult = plugin.decode(message);
  ...
  test('decodes Label H1 Preamble #M1BPRG', () => {
    ...
    message.text =
      '#M1BPRG/DTEKCH,22L,69,141204,042/FNSAS87W/TS132645,2402246784';
    const decodeResult = plugin.decode(message);
  ...
  test('decodes Label H1 PRG with flightplan', () => {
    ...
    message.text =
      'PRG/DTGCRR,03O,62,163055/PR1544,286,350,239,,0,66,,,50,,,P19,P0,27440,,1305,303/RP:DA:EDDB:AA:GCRR..N50059E004552..N49588E004338..N49241E002528..N49122E002199..PON.UN872..ERIGA..FUJTI:WS:FUJTI,360..BAKUP..BATAX..TAKAV..VEDOD:A:TERT1P:AP:ILSZ03.BAPAL(03O)226D';
    const decodeResult = plugin.decode(message);
