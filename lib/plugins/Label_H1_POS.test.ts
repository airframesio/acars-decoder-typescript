...
describe('Label_H1 POS', () => {
  ...
  test('#variant 7', () => {
    ...
    expect(decodeResult.formatted.items[2].value).toBe('18:46:00');
    expect(decodeResult.formatted.items[3].label).toBe('Aircraft Position');
    expect(decodeResult.formatted.items[3].value).toBe('42.965 N, 108.150 W');
    expect(decodeResult.formatted.items[4].label).toBe('Aircraft Route');
    expect(decodeResult.formatted.items[4].value).toBe('WAIDE@17:32:07 > WEDAK@03:17:59 > ?');
    expect(decodeResult.formatted.items[5].label).toBe('Altitude');
    expect(decodeResult.formatted.items[5].value).toBe('32000 feet');
    expect(decodeResult.formatted.items[6].label).toBe('Outside Air Temperature (C)');
    expect(decodeResult.formatted.items[6].value).toBe('-49 degrees');
    expect(decodeResult.formatted.items[7].label).toBe('Message Checksum');
    expect(decodeResult.formatted.items[7].value).toBe('0x4e17');
