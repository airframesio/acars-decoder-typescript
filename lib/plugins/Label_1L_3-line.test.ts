...
describe('Label_1L 3-line', () => {
  ...
  test('decodes variant 1', () => {
    message.text =
      '00018213200/GS 411500/DEP MDPC/DES CYYZ/ETA 0120/GW 479/ALT 39002' +
      '\r\n' +
    ...
    expect(decodeResult.remaining.text).toBe(
      '00018213200/GS 411500/GW 479/CAS 229/SAT - 59.0/TFQ 48/WD  20/WS  13',
    );
  });
  ...
  test('decodes no position', () => {
    ...
    expect(decodeResult.remaining.text).toBe(
      '00086213200/GS 497000/GW 700/CAS /SAT   15.0/TFQ 111/WD ---/WS ---',
    );
  });
