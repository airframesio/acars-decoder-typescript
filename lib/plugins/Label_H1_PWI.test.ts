...
describe('Label H1 PWI', () => {
  ...
  test('decodes Label H1 Preamble PWI valid', () => {
    ...
    expect(decodeResult.remaining.text).toBe(
      'DD300214059.240214040.180236024.100250018:,,,,/CB300246040.240246017.180226015.100210008',
    );
  });

  test('decodes Label H1 Preamble POS <invalid>', () => {
    message.text = 'PWI Bogus message';
    const decodeResult = plugin.decode(message);
