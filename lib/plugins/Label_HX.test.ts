...
describe('Label_HX', () => {
  ...
  test('decodes Label HX variant 2', () => {
    ...
    message.text = 'RA FMT 43 GSP B02';
    const decodeResult = plugin.decode(message);
